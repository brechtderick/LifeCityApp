...
function comparePasswords(control: AbstractControl): ValidationErrors {
  ...
  if(password && confirmPassword){
    return password.value === confirmPassword.value ? null as any 
    : { 'passwordsDiffer': true };
  }else{
    return { 'passwordsDiffer': false }
  }
  ...
  onSubmit() {
    this.authService
      .register(
         ...
         this.user? this.user.value.firstname : '',
         this.user? this.user.value.lastname: '',
         this.user? this.user.value.email: '',
         this.user? this.user.value.passwordGroup.password: ''
